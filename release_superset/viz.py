...
class DivergingViz(BaseViz):

    """Chart Diverging"""

    viz_type = 'diverging'
    verbose_name = _('diverging')
    is_timeseries = False
    credits = 'Everis Mexico'

    def query_obj(self):
        d = super(DivergingViz, self).query_obj()
        
        """
        logging.info(type(self.form_data))
        logging.info(self.form_data)
        """
    ...
    def evaluate_rangeMan(self):
        return None

    def evaluate_rangeWoman(self):
        return None    

    def get_data(self, df):

        logging.info("Datos CONSULTA GENERADA")
        values_man = { }

        values_man['_85_mas'] = 0
        values_man['_80_84'] = 0 
        values_man['_75_79'] = 0
        values_man['_70_74'] = 0
        values_man['_65_69'] = 0
        ...
        values_woman ={}
        values_woman['_85_mas'] = 0
        values_woman['_80_84'] = 0 
        values_woman['_75_79'] = 0
        values_woman['_70_74'] = 0
        values_woman['_65_69'] = 0
        values_woman['_60_64'] = 0
        values_woman['_55_59'] = 0
        values_woman['_50_54'] = 0
        values_woman['_45_49'] = 0
        values_woman['_40_44'] = 0
        values_woman['_35_39'] = 0
        values_woman['_30_34'] = 0
        values_woman['_25_29'] = 0
        values_woman['_20_24'] = 0
        values_woman['_15_19'] = 0
        values_woman['_10_14'] = 0
        values_woman['_05_09'] = 0
        values_woman['_00_04'] = 0

        #Group Totals by range
        # Hombre 21 2
        # Hombre 22 3
        #    =
        # Range 20-24  : 5
        ...
        for arrayDf in  df.values.tolist(): 
            gender        = arrayDf[0].strip()
            years_old     = int(arrayDf[1])
            total_count   = int(arrayDf[2])

            logging.info(gender + "-"+str(arrayDf[1]) + "-"+ str(arrayDf[2]))
            if  gender == 'Hombre':
                if years_old >= 85:
                    values_man['_85_mas'] = values_man['_85_mas'] + total_count
                if years_old >= 80 and years_old <=84:
                    values_man['_80_84'] = values_man['_80_84'] + total_count
                if years_old >= 75 and years_old <=79:
                    values_man['_75_79'] = values_man['_75_79'] + total_count
                if years_old >= 70 and years_old <=74:
                    values_man['_70_74'] = values_man['_70_74'] + total_count
                if years_old >= 65 and years_old <=69:
                    values_man['_65_69'] = values_man['_65_69'] + total_count
                if years_old >= 60 and years_old <=64:
                    values_man['_60_64'] = values_man['_60_64'] + total_count
                if years_old >= 55 and years_old <= 59:
                    values_man['_55_59'] = values_man['_55_59'] + total_count
                if years_old >= 50 and years_old <= 54:
                    values_man['_50_54'] = values_man['_50_54'] + total_count
                if years_old >= 45 and years_old <= 49:
                    values_man['_45_49'] = values_man['_45_49'] + total_count
                if years_old >= 40 and years_old <= 44:
                    values_man['_40_44'] = values_man['_40_44'] + total_count
                if years_old >= 35 and years_old <= 39:
                    values_man['_35_39'] = values_man['_35_39'] + total_count
                if years_old >= 30 and years_old <=34:
                    values_man['_30_34'] = values_man['_30_34'] + total_count
                if years_old >= 25 and years_old <= 29:
                    values_man['_25_29'] = values_man['_25_29'] + total_count
                if years_old >= 20 and years_old <= 24:
                    values_man['_20_24'] = values_man['_20_24'] + total_count
                if years_old >= 15 and years_old <=19:
                    values_man['_15_19'] = values_man['_15_19'] + total_count
                if years_old >= 10 and years_old < 14:
                    values_man['_10_14'] = values_man['_10_14'] + total_count
                if years_old >= 5 and years_old <=9:
                    values_man['_05_09'] = values_man['_05_09'] + total_count
                if years_old >= 0 and years_old <=4:
                    values_man['_00_04'] = values_man['_00_04'] + total_count
                
                totalGeneral =  totalGeneral + total_count

            if gender == 'Mujer':
                if years_old >= 85:
                    values_woman['_85_mas'] = values_woman['_85_mas'] + total_count
                if years_old >= 80 and years_old <=84:
                    values_woman['_80_84'] = values_woman['_80_84'] + total_count
                if years_old >= 75 and years_old <=79:
                    values_woman['_75_79'] = values_woman['_75_79'] + total_count
                if years_old >= 70 and years_old <=74:
                    values_woman['_70_74'] = values_woman['_70_74'] + total_count
                if years_old >= 65 and years_old <=69:
                    values_woman['_65_69'] = values_woman['_65_69'] + total_count
                if years_old >= 60 and years_old <=64:
                    values_woman['_60_64'] = values_woman['_60_64'] + total_count
                if years_old >= 55 and years_old <= 59:
                    values_woman['_55_59'] = values_woman['_55_59'] + total_count
                if years_old >= 50 and years_old <= 54:
                    values_woman['_50_54'] = values_woman['_50_54'] + total_count
                if years_old >= 45 and years_old <= 49:
                    values_woman['_45_49'] = values_woman['_45_49'] + total_count
                if years_old >= 40 and years_old <= 44:
                    values_woman['_40_44'] = values_woman['_40_44'] + total_count
                if years_old >= 35 and years_old <= 39:
                    values_woman['_35_39'] = values_woman['_35_39'] + total_count
                if years_old >= 30 and years_old <=34:
                    values_woman['_30_34'] = values_woman['_30_34'] + total_count
                if years_old >= 25 and years_old <= 29:
                    values_woman['_25_29'] = values_woman['_25_29'] + total_count
                if years_old >= 20 and years_old <= 24:
                    values_woman['_20_24'] = values_woman['_20_24'] + total_count
                if years_old >= 15 and years_old <=19:
                    values_woman['_15_19'] = values_woman['_15_19'] + total_count
                if years_old >= 10 and years_old < 14:
                    values_woman['_10_14'] = values_woman['_10_14'] + total_count
                if years_old >= 5 and years_old <=9:
                    values_woman['_05_09'] = values_woman['_05_09'] + total_count
                if years_old >= 0 and years_old <=4:
                    values_woman['_00_04'] = values_woman['_00_04'] + total_count

                totalGeneral =  totalGeneral + total_count

        logging.info("Total General: " + str( totalGeneral ) )
        ...
        tmpVM =[]
        tmpVM.append( round ( (values_man['_85_mas'] * 100) / totalGeneral ,2 ) )
        tmpVM.append( round ( (values_man['_80_84'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_75_79'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_70_74'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_65_69'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_60_64'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_55_59'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_50_54'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_45_49'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_40_44'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_35_39'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_30_34'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_25_29'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_20_24'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_15_19'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_10_14'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_05_09'] * 100) / totalGeneral ,2 ))
        tmpVM.append( round ( (values_man['_00_04'] * 100) / totalGeneral ,2 ))


        tmpVWM =[]
        tmpVWM.append( round ( (values_woman['_85_mas'] * 100) / totalGeneral ,2 ) )
        tmpVWM.append( round ( (values_woman['_80_84'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_75_79'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_70_74'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_65_69'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_60_64'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_55_59'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_50_54'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_45_49'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_40_44'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_35_39'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_30_34'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_25_29'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_20_24'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_15_19'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_10_14'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_05_09'] * 100) / totalGeneral ,2 ))
        tmpVWM.append( round ( (values_woman['_00_04'] * 100) / totalGeneral ,2 ))


        logging.info("MAN:")
        logging.info(values_man)

        logging.info("WOMAN:")
        logging.info(values_woman)

        logging.info("CALC MAN:")
        logging.info(tmpVM)

        logging.info("CALC WOMAN:")
        logging.info(tmpVWM)
        ...
        dfCustom   = pd.DataFrame(data)
        logging.info(dfCustom)
        #logging.info(dfCustom)

        return {
            #'content': df.values.tolist()
            'content': dfCustom.values.tolist()
            ,'headers':['label','percentMan','percentWoman']
        }
